...
function createAlert(alertType) {
    ...
    let toastRandom = Math.floor(Math.random() * 1000) + 1;
    toaster.innerHTML += `<div class="toast" id="toast${toastRandom}" role="alert" aria-live="assertive" aria-atomic="true" data-delay="5000">
