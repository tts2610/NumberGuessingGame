...
function insertPreviousRecord() {
    ...
    previousRecord.forEach(element => {
        ...
        p.className = "mt-2";
        var img = document.createElement("img")
        img.src = element[0] == "failed" ? "img/green_up.png" : "img/red_down.png";
        img.width = 64;
        img.height = 64;
        var textnode = document.createTextNode("Finished with " + (guess - element[1]) + " tries in " + (second - element[2]) + "s");
        p.appendChild(img);
        p.appendChild(textnode);
