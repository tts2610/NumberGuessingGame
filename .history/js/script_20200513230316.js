...
function createAlert(alertType) {
    ...
    var t = document.createTextNode(`<div class="toast" id="toast${alertType}" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="false">
    <div class="toast-header">
        <img class="rounded mr-2" alt="...">
        <strong class="mr-auto">Oopps</strong>
