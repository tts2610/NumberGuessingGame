...
function createAlert(alertType) {
    ...
    // alertTag.innerHTML = "";
    // alertTag.appendChild(alertDiv); data-delay="5000"

    toaster.innerHTML += `<div class="toast" id="toast" role="alert" aria-live="assertive" aria-atomic="true" data-delay="5000"  style="position: absolute; top: 0; right: 0;">
